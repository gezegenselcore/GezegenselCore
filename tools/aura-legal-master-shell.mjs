 ...
 * @param {{
 *   assetPrefix: string,
 *   seoKey: "aura_privacy" | "aura_terms" | "aura_support",
 *   dataTitleTr: string,
 *   dataTitleEn: string,
 *   articles: string,
 * }} cfg
...
<!--AURA_LANG_SWITCH-->
        ...
        <nav class="nav-desktop" aria-label="{{i18n:aura_legal.nav_aria}}">
          <a href="${hub}#ust">{{i18n:aura_legal.nav_home}}</a>
          <a href="${hub}#hakkinda">{{i18n:aura_legal.nav_about}}</a>
          <a href="${hub}#urunler">{{i18n:aura_legal.nav_products}}</a>
          <a href="${hub}#iletisim">{{i18n:aura_legal.nav_contact}}</a>
        </nav>
...
${articles}
  ...
  <footer class="site-footer">
    <nav class="gc-footer-nav" aria-label="{{i18n:aura_legal.footer_aria}}">
      <a href="${sitePrivacy}">
        ...
        {{i18n:aura_legal.footer_privacy}}
      </a>
      <a href="${siteSupport}">
        ...
        {{i18n:aura_legal.footer_support}}
      </a>
      <a href="${hub}#iletisim">
        ...
        {{i18n:aura_legal.footer_contact}}
      </a>
${FOOTER_SOCIAL}
    </nav>
    <p class="site-footer__legal">{{i18n:aura_legal.footer_legal}}</p>
  </footer>
